...
public partial class Account_Login : System.Web.UI.Page
{
    ...
    protected void btnPromeni_Click(object sender, EventArgs e)
    {
        ...
        komanda.Connection = connection;
            komanda.CommandText += @" INSERT INTO Korisnik (KorisnickoIme, Lozinka, KorisnikNivo_Id) VALUES ('" + tbKorisnickoIme.Text + "', '" + tbLozinkata.Text + "', "  + ddlNivo.SelectedValue + ") ; ";
            try
            {
                connection.Open();
                komanda.ExecuteNonQuery();
                ScriptManager.RegisterStartupScript(this.Page, this.Page.GetType(), "AlertPopup", "alert('Корисникот е додаден!');", true);
            }
